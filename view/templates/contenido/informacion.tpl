  ...
  <div id="contInfo">
    ...
    <div class="table-wrapper">
      <table class="table">
        ...
        <tbody>
          {section name=alumnos loop=$arr_alumnos}
            <tr>
              <td class="btnInfoCont">
                <!-- Botones de opciones -->
                <a class="btnInfo"><img src="img/editar-usuario.png"></a>
                <a href="index.php?accion=borrar_alumno&alumno_id={$arr_alumnos[alumnos].alumno_id}" class="btnInfo"
                  onclick="confirmarEliminacion(this)"> <img src="img/borrar-usuario.png"></a>
              </td>
              <td>{$arr_alumnos[alumnos].nombre_alumno}</td>
              <td>{$arr_alumnos[alumnos].edad}</td>
              <td>{$arr_alumnos[alumnos].direccion}</td>
              <td>{$arr_alumnos[alumnos].cedula}</td>
              <td>{$arr_alumnos[alumnos].telefono}</td>
              <td>{$arr_alumnos[alumnos].correo}</td>
              <td>{$arr_alumnos[alumnos].fecha_nac}</td>
              <td>{$arr_alumnos[alumnos].fecha_registro}</td>
            </tr>
          {/section}
        </tbody>
      </table>
